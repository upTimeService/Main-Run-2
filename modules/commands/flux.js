...
module.exports.run = async function ({ api, event, args }) {
  try {
    ...
    const API = `https://api.kenliejugarap.com/flux-realism/?width=19&height=19&prompt=${encodeURIComponent(prompt)}`;
    ...
    try {
      ...
      if (imageStream) {
        const path = __dirname + `/cache/flux.png`;
