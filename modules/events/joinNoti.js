...
.catch(error => {
    ...
    try {
      ...
      for (let o = 0; o < event.logMessageData.addedParticipants.length; o++) {
        ...
        ctx.save();
        ctx.font = `75px Semi`;
        ctx.fillText(`Welcome to our Group`, canvas.width / 2 - 15, canvas.height / 2 + 235)
        ...
        ctx.fillText(`TANVIR 143 BOT`, canvas.width / 2 - 15, canvas.height / 2 + 350);
        ctx.restore();
      ...
      (typeof threadData.customJoin == "undefined") ? msg = `[🤍] {name} আপনাকে\n {threadName} - গ্রুপে স্বাগতম 🖤🥀\n\n আপনি গ্রুপের {soThanhVien} নাম্বার সদস্য 🌟🖤 \n→ অ্যাড করেছে: {author}\n───────────────────\nআসা করি গ্রুপ রুলস মেনে চলবেন🖤`: msg = threadData.customJoin;
